...
function App() {
  return (
    <div className="min-h-screen bg-slate-900 scroll-smooth text-slate-200 font-sans">
      {/* Header */}
      ...
      <main className="pt-24 pb-16">
        <section className="max-w-4xl mx-auto px-6 py-20 flex flex-col items-center text-center">
          ...
          {/* Tagline */}
          <p className="text-lg text-slate-400 mb-8">Software Engineer</p>
